    ...
    extrapolation_map = {
        {"linear",
         [](const std::vector<std::vector<double>>& dataset) {
             return make_unique<Linear2DExtrapolation>(dataset);
         }},
        {"spline",
         [](const std::vector<std::vector<double>>& dataset) {
             return make_unique<Spline2DExtrapolation>(dataset);
         }},
        {"poly",
         [](const std::vector<std::vector<double>>& dataset) {
             return make_unique<Polynomial2DExtrapolation>(dataset);
         }},
        {"akima",
         [](const std::vector<std::vector<double>>& dataset) {
             return make_unique<Akima2DExtrapolation>(dataset);
         }},
        {"constant",
         [](const std::vector<std::vector<double>>& dataset) {
             return make_unique<Constant2DExtrapolation>(dataset);
         }},
        {"zero", [](const std::vector<std::vector<double>>& dataset) {
             return make_unique<Zero2DExtrapolation>(dataset);
         }}};
